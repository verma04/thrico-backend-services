  ...
  Query: {
    async getSurveys(_: any, { input }: any, context: any) {
      try {
        ...
        console.error("Error in getSurveys (user):", error);
        throw error;
      }
    },
    ...
    async getSurveyById(_: any, { id }: any, context: any) {
      try {
        ...
        console.error("Error in getSurveyById (user):", error);
        throw error;
      }
    },
  },
  Mutation: {
    async submitSurvey(_: any, { input }: any, context: any) {
      try {
        ...
        console.error("Error in submitSurvey (user):", error);
        throw error;
      }
    },
    ...
    async startSurvey(_: any, { surveyId }: any, context: any) {
      try {
        ...
        console.error("Error in startSurvey (user):", error);
        throw error;
      }
    },
    ...
    async saveSurveyResponse(_: any, { input }: any, context: any) {
      try {
        ...
        console.error("Error in saveSurveyResponse (user):", error);
        throw error;
      }
    },
  },
