...
const communitiesResolvers: any = {
  Query: {
    async getCommunityDetails(_: any, { input }: any, context: any) {
      try {
    ...
    async getCommunityAnalytics(_: any, { input }: any, context: any) {
      try {
        const authContext: any = await checkAuth(context);
    ...
    async getGroupJoinRequests(_: any, { input }: any, context: any) {
      try {
    ...
    async getCommunityAboutById(_: any, { input }: any, context: any) {
      try {
    ...
    async getCommunityReportReasons(_: any, {}: any, context: any) {
      try {
        context;
  ...
  Mutation: {
    ...
    async respondToJoinRequest(_: any, { input }: any, context: any) {
      try {
        const { db, userId, entityId } = await checkAuth(context);
    ...
    async reportCommunity(_: any, { input }: any, context: any) {
      try {
        ...
        const { communityId, reason, description } = input;
