...
--> statement-breakpoint
DO $$ BEGIN
 CREATE TYPE "source" AS ENUM('dashboard', 'group', 'event', 'jobs', 'marketPlace', 'rePost', 'story', 'admin', 'poll', 'offer', 'celebration', 'forum', 'survey');
EXCEPTION
 WHEN duplicate_object THEN null;
END $$;
--> statement-breakpoint
...
--> statement-breakpoint
DO $$ BEGIN
 CREATE TYPE "communityNotificationType" AS ENUM('WELCOME', 'JOIN_REQUEST', 'CREATED', 'MEMBER_JOINED', 'RATING_RECEIVED', 'ROLE_UPDATED', 'JOIN_APPROVED', 'POST_PENDING', 'POST_CREATED');
EXCEPTION
 WHEN duplicate_object THEN null;
END $$;
--> statement-breakpoint
DO $$ BEGIN
 CREATE TYPE "notificationType" AS ENUM('FEED_COMMENT', 'FEED_REPOST', 'FEED_LIKE', 'NETWORK', 'COMMUNITIES', 'LISTING_LIKE', 'JOB_LIKE', 'CONNECTION_REQUEST', 'CONNECTION_ACCEPTED', 'POINTS_EARNED', 'BADGE_UNLOCKED', 'RANK_UP', 'COMMUNITY_CREATED', 'COMMUNITY_JOIN_REQUEST', 'COMMUNITY_RATING', 'COMMUNITY_ROLE_UPDATED', 'COMMUNITY_JOIN_APPROVED', 'LISTING_APPROVED', 'LISTING_CONTACT', 'LISTING_MESSAGE', 'JOB_APPLICATION', 'JOB_POSTED', 'POLL_VOTE');
EXCEPTION
 WHEN duplicate_object THEN null;
END $$;
--> statement-breakpoint
