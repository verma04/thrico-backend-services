...
--> statement-breakpoint
DO $$ BEGIN
 CREATE TYPE "userStatus" AS ENUM('APPROVED', 'BLOCKED', 'PENDING', 'REJECTED', 'FLAGGED', 'DISABLED', 'SUSPENDED', 'DELETED');
EXCEPTION
 WHEN duplicate_object THEN null;
END $$;
--> statement-breakpoint
...
--> statement-breakpoint
DO $$ BEGIN
 CREATE TYPE "registrationFieldType" AS ENUM('text', 'email', 'phone', 'select', 'textarea', 'checkbox');
EXCEPTION
 WHEN duplicate_object THEN null;
END $$;
--> statement-breakpoint
...
--> statement-breakpoint
DO $$ BEGIN
 CREATE TYPE "managerRole" AS ENUM('ADMIN', 'MANAGER', 'MODERATOR', 'USER', 'NOT_MEMBER');
EXCEPTION
 WHEN duplicate_object THEN null;
END $$;
--> statement-breakpoint
...
--> statement-breakpoint
DO $$ BEGIN
 CREATE TYPE "source" AS ENUM('dashboard', 'group', 'event', 'jobs', 'marketPlace', 'rePost', 'story', 'admin', 'poll', 'offer', 'celebration', 'forum', 'survey', 'moment');
EXCEPTION
 WHEN duplicate_object THEN null;
END $$;
--> statement-breakpoint
...
--> statement-breakpoint
DO $$ BEGIN
 CREATE TYPE "mentorServicesType" AS ENUM('1:1 call', 'webinar');
EXCEPTION
 WHEN duplicate_object THEN null;
END $$;
--> statement-breakpoint
...
--> statement-breakpoint
DO $$ BEGIN
 CREATE TYPE "chatTypeEnum" AS ENUM('CONNECTION', 'MARKETPLACE', 'MENTORSHIP');
EXCEPTION
 WHEN duplicate_object THEN null;
END $$;
--> statement-breakpoint
...
--> statement-breakpoint
DO $$ BEGIN
 CREATE TYPE "communityNotificationType" AS ENUM('COMMUNITY_WELCOME', 'COMMUNITY_JOIN_REQUEST', 'COMMUNITY_CREATED', 'COMMUNITY_MEMBER_JOINED', 'COMMUNITY_RATING_RECEIVED', 'COMMUNITY_ROLE_UPDATED', 'COMMUNITY_JOIN_APPROVED', 'COMMUNITY_POST_PENDING', 'COMMUNITY_POST_CREATED', 'COMMUNITY_POST_APPROVED');
EXCEPTION
 WHEN duplicate_object THEN null;
END $$;
--> statement-breakpoint
DO $$ BEGIN
 CREATE TYPE "feedNotificationType" AS ENUM('FEED_COMMENT', 'FEED_LIKE', 'FEED_REPOST', 'POLL_VOTE', 'CLOSE_FRIEND_STORY', 'STORY', 'FEED_POST');
EXCEPTION
 WHEN duplicate_object THEN null;
END $$;
--> statement-breakpoint
DO $$ BEGIN
 CREATE TYPE "gamificationNotificationType" AS ENUM('POINTS_EARNED', 'BADGE_UNLOCKED', 'RANK_UP', 'LEADERBOARD');
EXCEPTION
 WHEN duplicate_object THEN null;
END $$;
--> statement-breakpoint
...
--> statement-breakpoint
DO $$ BEGIN
 CREATE TYPE "question_type" AS ENUM('SHORT_TEXT', 'LONG_TEXT', 'EMAIL', 'PHONE', 'WEBSITE', 'NUMBER', 'OPINION_SCALE', 'RATING', 'MULTIPLE_CHOICE', 'DROPDOWN', 'ISOPTION', 'DATE', 'TIME', 'YES_NO', 'LEGAL');
EXCEPTION
 WHEN duplicate_object THEN null;
END $$;
--> statement-breakpoint
...
--> statement-breakpoint
DO $$ BEGIN
 CREATE TYPE "points_ddssdmodule" AS ENUM('FEED', 'LISTING', 'SURVEY');
EXCEPTION
 WHEN duplicate_object THEN null;
END $$;
--> statement-breakpoint
...
--> statement-breakpoint
DO $$ BEGIN
 CREATE TYPE "user_action_gamification" AS ENUM('LIKE_FEED', 'POST_FEED', 'COMMENT_FEED', 'SHARE_FEED', 'POST_LISTING', 'SHARE_LISTING', 'SUBMIT_SURVEY');
EXCEPTION
 WHEN duplicate_object THEN null;
END $$;
--> statement-breakpoint
...
--> statement-breakpoint
DO $$ BEGIN
 CREATE TYPE "prize_type" AS ENUM('TC', 'VOUCHER', 'PREMIUM', 'NOTHING');
EXCEPTION
 WHEN duplicate_object THEN null;
END $$;
--> statement-breakpoint
DO $$ BEGIN
 CREATE TYPE "momentStatus" AS ENUM('UPLOADING', 'PROCESSING', 'PUBLISHED', 'FAILED');
EXCEPTION
 WHEN duplicate_object THEN null;
END $$;
--> statement-breakpoint
...
--> statement-breakpoint
DO $$ BEGIN
 CREATE TYPE "ai_classification" AS ENUM('safe', 'spam', 'offensive', 'harassment', 'unclassifiable');
EXCEPTION
 WHEN duplicate_object THEN null;
END $$;
--> statement-breakpoint
...
--> statement-breakpoint
DO $$ BEGIN
 CREATE TYPE "storageModule" AS ENUM('FEED', 'MEMBER', 'DISCUSSION_FORUM', 'COMMUNITY', 'JOB', 'LISTING', 'MOMENT', 'OFFER', 'EVENT', 'USER', 'SHOP', 'SURVEY', 'MESSAGING', 'GENERAL', 'OFFERS', 'PAGES', 'REWARDS');
EXCEPTION
 WHEN duplicate_object THEN null;
END $$;
--> statement-breakpoint
...
CREATE TABLE IF NOT EXISTS "mcp_keys" (
	...
	"created_at" timestamp DEFAULT now(),
	"updated_at" timestamp DEFAULT now(),
	CONSTRAINT "mcp_keys_api_key_unique" UNIQUE("api_key")
);
--> statement-breakpoint
...
CREATE TABLE IF NOT EXISTS "entitySettings" (
	...
	"faqRewards" jsonb,
	"allowEntityCommunityInFeed" boolean DEFAULT true,
	"allowEntityDiscussionForumInFeed" boolean DEFAULT true,
	"allowEntityPollsInFeed" boolean DEFAULT true,
	"allowEntityFeedInFeed" boolean DEFAULT true,
	"allowEntityMomentsInFeed" boolean DEFAULT true,
	"feedOrders" jsonb,
	"feedEntityName" text
);
--> statement-breakpoint
...
CREATE TABLE IF NOT EXISTS "thricoUser" (
	...
	"referralCode" text,
	"referredBy" text,
	CONSTRAINT "thricoUser_referralCode_unique" UNIQUE("referralCode"),
...
CREATE TABLE IF NOT EXISTS "eventsss" (
	...
	"cover" text DEFAULT 'default-events.png' NOT NULL,
	"title" text NOT NULL,
	"slug" text NOT NULL,
...
CREATE TABLE IF NOT EXISTS "eventsAttendees" (
	...
	"ticket_id" uuid,
	"status" "attendeeStatus" DEFAULT 'CONFIRMED' NOT NULL,
...
--> statement-breakpoint
CREATE TABLE IF NOT EXISTS "eventsPromoCodes" (
	"id" uuid PRIMARY KEY DEFAULT gen_random_uuid() NOT NULL,
	"event_id" uuid NOT NULL,
	"code" text NOT NULL,
	...
	"applicableTickets" jsonb,
	"created_at" timestamp DEFAULT now() NOT NULL,
	"updated_at" timestamp DEFAULT now() NOT NULL,
	"status" boolean DEFAULT true NOT NULL
);
--> statement-breakpoint
CREATE TABLE IF NOT EXISTS "eventsRegistrationFields" (
	"id" uuid PRIMARY KEY DEFAULT gen_random_uuid() NOT NULL,
	"event_id" uuid NOT NULL,
	"label" text NOT NULL,
...
--> statement-breakpoint
CREATE TABLE IF NOT EXISTS "eventsRegistrationSettings" (
	"id" uuid PRIMARY KEY DEFAULT gen_random_uuid() NOT NULL,
	"event_id" uuid NOT NULL,
	"isRegistrationOpen" boolean DEFAULT true NOT NULL,
	"enableWaitlist" boolean DEFAULT true NOT NULL,
...
--> statement-breakpoint
CREATE TABLE IF NOT EXISTS "eventsTickets" (
	"id" uuid PRIMARY KEY DEFAULT gen_random_uuid() NOT NULL,
	"event_id" uuid NOT NULL,
	"name" text NOT NULL,
	...
	"description" text,
	"earlyBirdPrice" numeric,
	"earlyBirdDeadline" date,
	"maxPerOrder" integer DEFAULT 1 NOT NULL,
...
CREATE TABLE IF NOT EXISTS "-community" (
	...
	"addedBy" "addedBy",
	"org_id" uuid NOT NULL,
	"cover" text DEFAULT 'default_communities.png',
	"status" "communityEntityStatus" NOT NULL,
	"isApproved" boolean DEFAULT false NOT NULL,
...
CREATE TABLE IF NOT EXISTS "userFeed" (
	...
	"moderation_result" text,
	"moderated_at" timestamp,
	"is_ai_content" boolean DEFAULT false
);
--> statement-breakpoint
...
CREATE TABLE IF NOT EXISTS "mentorships" (
	...
	"agreement" boolean NOT NULL,
	"isFeatured" boolean DEFAULT false NOT NULL,
	"isTopMentor" boolean DEFAULT false NOT NULL,
	"created_at" timestamp DEFAULT now(),
	"updated_at" timestamp DEFAULT CURRENT_TIMESTAMP,
	"category" text,
	"skills" jsonb,
...
CREATE TABLE IF NOT EXISTS "chats" (
	...
	"chatType" "chatTypeEnum" DEFAULT 'CONNECTION' NOT NULL,
...
CREATE TABLE IF NOT EXISTS "jobNotifications" (
	"id" uuid PRIMARY KEY DEFAULT gen_random_uuid() NOT NULL,
	"type" "jobNotificationType" NOT NULL,
	"user_id" uuid NOT NULL,
	"sender_id" uuid,
	"entity_id" uuid NOT NULL,
	"job_id" uuid NOT NULL,
...
CREATE TABLE IF NOT EXISTS "listingNotifications" (
	"id" uuid PRIMARY KEY DEFAULT gen_random_uuid() NOT NULL,
	"type" "listingNotificationType" NOT NULL,
	"user_id" uuid NOT NULL,
	"sender_id" uuid,
	"entity_id" uuid NOT NULL,
...
CREATE TABLE IF NOT EXISTS "surveys" (
	...
	"end_date" timestamp,
	"shared_as_feed" boolean DEFAULT false,
	"created_at" timestamp DEFAULT now(),
	"updated_at" timestamp DEFAULT CURRENT_TIMESTAMP
);
--> statement-breakpoint
...
CREATE TABLE IF NOT EXISTS "shop_products" (
	...
	"number_of_variants" integer DEFAULT 0 NOT NULL,
	"created_at" timestamp DEFAULT now() NOT NULL,
...
--> statement-breakpoint
CREATE TABLE IF NOT EXISTS "currency_activity_caps" (
	"id" uuid PRIMARY KEY DEFAULT gen_random_uuid() NOT NULL,
	"entity_id" uuid NOT NULL,
	...
	"created_at" timestamp DEFAULT now() NOT NULL,
	"updated_at" timestamp DEFAULT now() NOT NULL,
	CONSTRAINT "currency_activity_caps_entity_id_activity_type_unique" UNIQUE("entity_id","activity_type")
);
--> statement-breakpoint
CREATE TABLE IF NOT EXISTS "entity_currency_config" (
	"id" uuid PRIMARY KEY DEFAULT gen_random_uuid() NOT NULL,
	"entity_id" uuid NOT NULL,
	"currency_name" varchar(100) DEFAULT 'Coins' NOT NULL,
	"normalization_factor" integer DEFAULT 10 NOT NULL,
	"tc_conversion_rate" numeric(10, 4) DEFAULT '1.0' NOT NULL,
	"tc_coins_allowed" boolean DEFAULT false NOT NULL,
	"min_tc_percentage" integer DEFAULT 10 NOT NULL,
	"max_tc_percentage" integer DEFAULT 30 NOT NULL,
	"min_entity_activity_required" boolean DEFAULT true NOT NULL,
	"created_at" timestamp DEFAULT now() NOT NULL,
	"updated_at" timestamp DEFAULT now() NOT NULL,
	CONSTRAINT "entity_currency_config_entity_id_unique" UNIQUE("entity_id")
);
--> statement-breakpoint
CREATE TABLE IF NOT EXISTS "entity_currency_wallet" (
	"id" uuid PRIMARY KEY DEFAULT gen_random_uuid() NOT NULL,
	"user_id" uuid NOT NULL,
	"entity_id" uuid NOT NULL,
	...
	"total_converted_to_tc" numeric(18, 4) DEFAULT '0' NOT NULL,
	"created_at" timestamp DEFAULT now() NOT NULL,
	"updated_at" timestamp DEFAULT now() NOT NULL,
	CONSTRAINT "entity_currency_wallet_user_id_entity_id_unique" UNIQUE("user_id","entity_id")
);
--> statement-breakpoint
CREATE TABLE IF NOT EXISTS "redemption_caps" (
	"id" uuid PRIMARY KEY DEFAULT gen_random_uuid() NOT NULL,
	"entity_id" uuid NOT NULL,
	"max_tc_per_order" numeric(18, 4) DEFAULT '0' NOT NULL,
	"max_tc_per_month" numeric(18, 4) DEFAULT '0' NOT NULL,
	"created_at" timestamp DEFAULT now() NOT NULL,
	"updated_at" timestamp DEFAULT now() NOT NULL,
	CONSTRAINT "redemption_caps_entity_id_unique" UNIQUE("entity_id")
);
--> statement-breakpoint
CREATE TABLE IF NOT EXISTS "tc_coin_wallet" (
	"id" uuid PRIMARY KEY DEFAULT gen_random_uuid() NOT NULL,
	"thrico_id" uuid NOT NULL,
	"balance" numeric(18, 4) DEFAULT '0' NOT NULL,
	"total_earned" numeric(18, 4) DEFAULT '0' NOT NULL,
	"total_spent" numeric(18, 4) DEFAULT '0' NOT NULL,
	"created_at" timestamp DEFAULT now() NOT NULL,
	"updated_at" timestamp DEFAULT now() NOT NULL,
	CONSTRAINT "tc_coin_wallet_thrico_id_unique" UNIQUE("thrico_id")
);
--> statement-breakpoint
CREATE TABLE IF NOT EXISTS "tc_conversion_caps" (
	"id" uuid PRIMARY KEY DEFAULT gen_random_uuid() NOT NULL,
	"entity_id" uuid NOT NULL,
	"max_tc_per_day" numeric(18, 4) DEFAULT '0' NOT NULL,
	"max_tc_per_month" numeric(18, 4) DEFAULT '0' NOT NULL,
	"max_tc_per_entity" numeric(18, 4) DEFAULT '0' NOT NULL,
	"created_at" timestamp DEFAULT now() NOT NULL,
	"updated_at" timestamp DEFAULT now() NOT NULL,
	CONSTRAINT "tc_conversion_caps_entity_id_unique" UNIQUE("entity_id")
);
--> statement-breakpoint
CREATE TABLE IF NOT EXISTS "redemptions_log" (
	...
	"ec_used" integer DEFAULT 0 NOT NULL,
	"tc_used" integer DEFAULT 0 NOT NULL,
...
CREATE TABLE IF NOT EXISTS "rewards" (
	...
	"description" text,
	"image" text,
	"tc_cost" integer DEFAULT 0 NOT NULL,
	"inventory_required" boolean DEFAULT false NOT NULL,
	"per_user_limit" integer DEFAULT 1 NOT NULL,
	"total_usage_limit" integer DEFAULT 0 NOT NULL,
	"min_account_age" integer DEFAULT 0 NOT NULL,
	"min_activity_required" integer DEFAULT 0 NOT NULL,
	"block_warned_users" boolean DEFAULT false NOT NULL,
	...
	"created_at" timestamp DEFAULT now() NOT NULL,
	"updated_at" timestamp DEFAULT CURRENT_TIMESTAMP,
	"reward_mechanism" text[] DEFAULT ARRAY['COUPON']::text[] NOT NULL
);
--> statement-breakpoint
...
CREATE TABLE IF NOT EXISTS "match_win_config" (
	"id" uuid PRIMARY KEY DEFAULT gen_random_uuid() NOT NULL,
	"entity_id" uuid NOT NULL,
	"cost_per_play" integer DEFAULT 25 NOT NULL,
...
--> statement-breakpoint
CREATE TABLE IF NOT EXISTS "match_win_plays" (
	"id" uuid PRIMARY KEY DEFAULT gen_random_uuid() NOT NULL,
	"user_id" uuid NOT NULL,
	"entity_id" uuid NOT NULL,
	"combination_id" uuid,
...
CREATE TABLE IF NOT EXISTS "scratch_card_config" (
	"id" uuid PRIMARY KEY DEFAULT gen_random_uuid() NOT NULL,
	"entity_id" uuid NOT NULL,
	"cost_per_scratch" integer DEFAULT 15 NOT NULL,
	"max_scratches_per_day" integer DEFAULT 5 NOT NULL,
	"is_active" boolean DEFAULT false NOT NULL,
	"campaign_start_date" timestamp,
	"campaign_end_date" timestamp,
	"created_at" timestamp DEFAULT now() NOT NULL,
	"updated_at" timestamp DEFAULT now() NOT NULL,
	CONSTRAINT "scratch_card_config_entity_id_unique" UNIQUE("entity_id")
);
--> statement-breakpoint
...
CREATE TABLE IF NOT EXISTS "spin_wheel_config" (
	"id" uuid PRIMARY KEY DEFAULT gen_random_uuid() NOT NULL,
	"entity_id" uuid NOT NULL,
	"cost_per_spin" integer DEFAULT 20 NOT NULL,
	"max_spins_per_day" integer DEFAULT 3 NOT NULL,
	"is_active" boolean DEFAULT false NOT NULL,
	"campaign_start_date" timestamp,
	"campaign_end_date" timestamp,
	"created_at" timestamp DEFAULT now() NOT NULL,
	"updated_at" timestamp DEFAULT now() NOT NULL,
	CONSTRAINT "spin_wheel_config_entity_id_unique" UNIQUE("entity_id")
);
--> statement-breakpoint
...
CREATE TABLE IF NOT EXISTS "moment_reactions" (
	...
	"created_at" timestamp DEFAULT now(),
	"updated_at" timestamp DEFAULT CURRENT_TIMESTAMP,
	"reactions_type" "reactionsType" DEFAULT 'like' NOT NULL,
	"liked_by" "addedBy" DEFAULT 'USER',
	CONSTRAINT "moment_reactions_user_id_moment_id_unique" UNIQUE("user_id","moment_id")
);
--> statement-breakpoint
...
--> statement-breakpoint
CREATE TABLE IF NOT EXISTS "moment_wishlist" (
	"id" uuid PRIMARY KEY DEFAULT gen_random_uuid() NOT NULL,
	"user_id" uuid NOT NULL,
	"moment_id" uuid NOT NULL,
	"entity_id" uuid NOT NULL,
	"created_at" timestamp DEFAULT now(),
	CONSTRAINT "moment_wishlist_user_id_moment_id_unique" UNIQUE("user_id","moment_id")
);
--> statement-breakpoint
CREATE TABLE IF NOT EXISTS "thrico_moments" (
	"id" uuid PRIMARY KEY DEFAULT gen_random_uuid() NOT NULL,
	...
	"status" "momentStatus" DEFAULT 'UPLOADING' NOT NULL,
	"created_at" timestamp DEFAULT now(),
	"updated_at" timestamp DEFAULT CURRENT_TIMESTAMP,
	"total_reactions" integer DEFAULT 0 NOT NULL,
	"total_comments" integer DEFAULT 0 NOT NULL,
	"total_reshares" integer DEFAULT 0 NOT NULL,
...
CREATE TABLE IF NOT EXISTS "moderation_settings" (
	...
	"ai_classification_definitions" jsonb,
	"created_at" timestamp DEFAULT now(),
	"updated_at" timestamp DEFAULT now(),
...
CREATE INDEX IF NOT EXISTS "moment_views_user_id_idx" ON "moment_views" ("user_id");--> statement-breakpoint
CREATE INDEX IF NOT EXISTS "moment_views_moment_id_idx" ON "moment_views" ("moment_id");--> statement-breakpoint
...
--> statement-breakpoint
DO $$ BEGIN
 ALTER TABLE "eventsAttendees" ADD CONSTRAINT "eventsAttendees_ticket_id_eventsTickets_id_fk" FOREIGN KEY ("ticket_id") REFERENCES "eventsTickets"("id") ON DELETE set null ON UPDATE no action;
EXCEPTION
 WHEN duplicate_object THEN null;
END $$;
--> statement-breakpoint
DO $$ BEGIN
 ALTER TABLE "eventsPromoCodes" ADD CONSTRAINT "eventsPromoCodes_event_id_eventsss_id_fk" FOREIGN KEY ("event_id") REFERENCES "eventsss"("id") ON DELETE cascade ON UPDATE no action;
EXCEPTION
 WHEN duplicate_object THEN null;
END $$;
--> statement-breakpoint
DO $$ BEGIN
 ALTER TABLE "eventsRegistrationFields" ADD CONSTRAINT "eventsRegistrationFields_event_id_eventsss_id_fk" FOREIGN KEY ("event_id") REFERENCES "eventsss"("id") ON DELETE cascade ON UPDATE no action;
EXCEPTION
 WHEN duplicate_object THEN null;
END $$;
--> statement-breakpoint
DO $$ BEGIN
 ALTER TABLE "eventsRegistrationSettings" ADD CONSTRAINT "eventsRegistrationSettings_event_id_eventsss_id_fk" FOREIGN KEY ("event_id") REFERENCES "eventsss"("id") ON DELETE cascade ON UPDATE no action;
EXCEPTION
 WHEN duplicate_object THEN null;
END $$;
--> statement-breakpoint
...
--> statement-breakpoint
DO $$ BEGIN
 ALTER TABLE "eventsTickets" ADD CONSTRAINT "eventsTickets_event_id_eventsss_id_fk" FOREIGN KEY ("event_id") REFERENCES "eventsss"("id") ON DELETE cascade ON UPDATE no action;
EXCEPTION
 WHEN duplicate_object THEN null;
END $$;
--> statement-breakpoint
...
--> statement-breakpoint
DO $$ BEGIN
 ALTER TABLE "redemptions_log" ADD CONSTRAINT "redemptions_log_user_id_thricoUser_id_fk" FOREIGN KEY ("user_id") REFERENCES "thricoUser"("id") ON DELETE no action ON UPDATE no action;
EXCEPTION
 WHEN duplicate_object THEN null;
END $$;
--> statement-breakpoint
DO $$ BEGIN
 ALTER TABLE "redemptions_log" ADD CONSTRAINT "redemptions_log_reward_id_rewards_id_fk" FOREIGN KEY ("reward_id") REFERENCES "rewards"("id") ON DELETE no action ON UPDATE no action;
EXCEPTION
 WHEN duplicate_object THEN null;
END $$;
--> statement-breakpoint
DO $$ BEGIN
 ALTER TABLE "vouchers" ADD CONSTRAINT "vouchers_reward_id_rewards_id_fk" FOREIGN KEY ("reward_id") REFERENCES "rewards"("id") ON DELETE no action ON UPDATE no action;
EXCEPTION
 WHEN duplicate_object THEN null;
END $$;
--> statement-breakpoint
DO $$ BEGIN
 ALTER TABLE "vouchers" ADD CONSTRAINT "vouchers_assigned_to_thricoUser_id_fk" FOREIGN KEY ("assigned_to") REFERENCES "thricoUser"("id") ON DELETE no action ON UPDATE no action;
EXCEPTION
 WHEN duplicate_object THEN null;
END $$;
--> statement-breakpoint
...
--> statement-breakpoint
DO $$ BEGIN
 ALTER TABLE "scratch_card_plays" ADD CONSTRAINT "scratch_card_plays_user_id_thricoUser_id_fk" FOREIGN KEY ("user_id") REFERENCES "thricoUser"("id") ON DELETE no action ON UPDATE no action;
EXCEPTION
 WHEN duplicate_object THEN null;
END $$;
--> statement-breakpoint
DO $$ BEGIN
 ALTER TABLE "scratch_card_plays" ADD CONSTRAINT "scratch_card_plays_prize_id_scratch_card_prizes_id_fk" FOREIGN KEY ("prize_id") REFERENCES "scratch_card_prizes"("id") ON DELETE no action ON UPDATE no action;
EXCEPTION
 WHEN duplicate_object THEN null;
END $$;
--> statement-breakpoint
DO $$ BEGIN
 ALTER TABLE "scratch_card_prizes" ADD CONSTRAINT "scratch_card_prizes_config_id_scratch_card_config_id_fk" FOREIGN KEY ("config_id") REFERENCES "scratch_card_config"("id") ON DELETE cascade ON UPDATE no action;
EXCEPTION
 WHEN duplicate_object THEN null;
END $$;
--> statement-breakpoint
DO $$ BEGIN
 ALTER TABLE "spin_wheel_plays" ADD CONSTRAINT "spin_wheel_plays_user_id_thricoUser_id_fk" FOREIGN KEY ("user_id") REFERENCES "thricoUser"("id") ON DELETE no action ON UPDATE no action;
EXCEPTION
 WHEN duplicate_object THEN null;
END $$;
--> statement-breakpoint
DO $$ BEGIN
 ALTER TABLE "spin_wheel_plays" ADD CONSTRAINT "spin_wheel_plays_prize_id_spin_wheel_prizes_id_fk" FOREIGN KEY ("prize_id") REFERENCES "spin_wheel_prizes"("id") ON DELETE no action ON UPDATE no action;
EXCEPTION
 WHEN duplicate_object THEN null;
END $$;
--> statement-breakpoint
DO $$ BEGIN
 ALTER TABLE "spin_wheel_prizes" ADD CONSTRAINT "spin_wheel_prizes_config_id_spin_wheel_config_id_fk" FOREIGN KEY ("config_id") REFERENCES "spin_wheel_config"("id") ON DELETE cascade ON UPDATE no action;
EXCEPTION
 WHEN duplicate_object THEN null;
END $$;
--> statement-breakpoint
DO $$ BEGIN
 ALTER TABLE "spin_wheel_prizes" ADD CONSTRAINT "spin_wheel_prizes_reward_id_rewards_id_fk" FOREIGN KEY ("reward_id") REFERENCES "rewards"("id") ON DELETE no action ON UPDATE no action;
EXCEPTION
 WHEN duplicate_object THEN null;
END $$;
--> statement-breakpoint
DO $$ BEGIN
 ALTER TABLE "moment_comments" ADD CONSTRAINT "moment_comments_moment_id_thrico_moments_id_fk" FOREIGN KEY ("moment_id") REFERENCES "thrico_moments"("id") ON DELETE cascade ON UPDATE no action;
EXCEPTION
 WHEN duplicate_object THEN null;
END $$;
--> statement-breakpoint
DO $$ BEGIN
 ALTER TABLE "moment_reactions" ADD CONSTRAINT "moment_reactions_moment_id_thrico_moments_id_fk" FOREIGN KEY ("moment_id") REFERENCES "thrico_moments"("id") ON DELETE cascade ON UPDATE no action;
EXCEPTION
 WHEN duplicate_object THEN null;
END $$;
--> statement-breakpoint
DO $$ BEGIN
 ALTER TABLE "moment_views" ADD CONSTRAINT "moment_views_moment_id_thrico_moments_id_fk" FOREIGN KEY ("moment_id") REFERENCES "thrico_moments"("id") ON DELETE cascade ON UPDATE no action;
EXCEPTION
 WHEN duplicate_object THEN null;
END $$;
--> statement-breakpoint
DO $$ BEGIN
 ALTER TABLE "moment_wishlist" ADD CONSTRAINT "moment_wishlist_moment_id_thrico_moments_id_fk" FOREIGN KEY ("moment_id") REFERENCES "thrico_moments"("id") ON DELETE cascade ON UPDATE no action;
EXCEPTION
 WHEN duplicate_object THEN null;
END $$;
--> statement-breakpoint
...
--> statement-breakpoint
DO $$ BEGIN
 ALTER TABLE "moderation_jobs" ADD CONSTRAINT "moderation_jobs_entity_id_entity_id_fk" FOREIGN KEY ("entity_id") REFERENCES "entity"("id") ON DELETE no action ON UPDATE no action;
EXCEPTION
 WHEN duplicate_object THEN null;
END $$;
--> statement-breakpoint
