...
class SubscriptionClient {
  ...
  async checkEntitySubscription(entityId: string): Promise<any> {
    return new Promise((resolve, reject) => {
      this.client.CheckEntitySubscription(
        { entityId },
        (error: grpc.ServiceError | null, response: any) => {
          if (error) {
            log.error("gRPC CheckEntitySubscription error", {
              entityId,
              error: error.message,
            });
            reject(error);
  ...
  async updateTrialToPackage(
    ...
    return new Promise((resolve, reject) => {
      this.client.UpdateTrialToPackage(
        ...
        (error: grpc.ServiceError | null, response: any) => {
          if (error) {
            log.error("gRPC UpdateTrialToPackage error", {
              entityId,
              packageId,
              error: error.message,
            });
  ...
  async subscribeTrial(entityId: string, countryCode: string): Promise<any> {
    return new Promise((resolve, reject) => {
      this.client.SubscribeTrial(
        ...
        (error: grpc.ServiceError | null, response: any) => {
          if (error) {
            log.error("gRPC SubscribeTrial error", {
              entityId,
              countryCode,
              error: error.message,
            });
  ...
  async verifyRazorpayPayment(
    ...
    return new Promise((resolve, reject) => {
      this.client.VerifyRazorpayPayment(
        ...
        (error: grpc.ServiceError | null, response: any) => {
          if (error) {
            log.error("gRPC VerifyRazorpayPayment error", {
              razorpayOrderId,
              error: error.message,
            });
            reject(error);
  ...
  async getPlanOverview(entityId: string): Promise<any> {
    return new Promise((resolve, reject) => {
      this.client.GetPlanOverview(
        ...
        (error: grpc.ServiceError | null, response: any) => {
          if (error) {
            log.error("gRPC GetPlanOverview error", {
              entityId,
              error: error.message,
            });
            reject(error);
  ...
  async getUpgradePlanSummary(params: {
    ...
    return new Promise((resolve, reject) => {
      this.client.upgradePlanSummary(
        ...
        (error: grpc.ServiceError | null, response: any) => {
          if (error) {
            log.error("gRPC upgradePlanSummary error", {
              ...params,
              error: error.message,
            });
            reject(error);
  ...
  async updateToYearly(params: {
    ...
    return new Promise((resolve, reject) => {
      this.client.UpdateToYearly(
        ...
        (error: grpc.ServiceError | null, response: any) => {
          if (error) {
            log.error("gRPC UpdateToYearly error", {
              ...params,
              error: error.message,
            });
            reject(error);
  ...
  async updateToYearlySummary(params: {
    ...
    return new Promise((resolve, reject) => {
      this.client.UpdateToYearlySummary(
        params,
        (error: grpc.ServiceError | null, response: any) => {
          if (error) {
            log.error("gRPC UpdateToYearlySummary error", {
              ...params,
              error: error.message,
            });
            reject(error);
  ...
  async upgradePlan(params: {
    ...
    return new Promise((resolve, reject) => {
      this.client.UpgradePlan(
        ...
        (error: grpc.ServiceError | null, response: any) => {
          if (error) {
            log.error("gRPC UpgradePlan error", {
              ...params,
              error: error.message,
            });
            reject(error);
  ...
  async updateEntityModules(
    ...
    return new Promise((resolve, reject) => {
      this.client.UpdateEntityModules(
        ...
        (error: grpc.ServiceError | null, response: any) => {
          if (error) {
            log.error("gRPC UpdateEntityModules error", {
              entityId,
              error: error.message,
            });
            reject(error);
  ...
  async getAllEntityInvoice(entityId: string): Promise<any> {
    return new Promise((resolve, reject) => {
      this.client.GetAllEntityInvoice(
        ...
        (error: grpc.ServiceError | null, response: any) => {
          if (error) {
            log.error("gRPC GetAllEntityInvoice error", {
              entityId,
              error: error.message,
            });
            reject(error);
  ...
  async updateBillingInvoicePdfUrl(
    billingId: string,
    ...
    return new Promise((resolve, reject) => {
      this.client.updateBillingInvoicePdfUrl(
        ...
        (error: grpc.ServiceError | null, response: any) => {
          if (error) {
            log.error("gRPC updateBillingInvoicePdfUrl error", {
              billingId,
              error: error.message,
            });
            reject(error);
